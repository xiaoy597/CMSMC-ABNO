...
INSERT INTO $PARAM{'CMSSDB'}.ABNO_INCM_CALC_INVST (ABNO_INCM_CALC_BTCH, PRMT_TYPE, PRMT_VAL)
SELECT DISTINCT '$PARAM{'abno_incm_calc_btch'}', '1', A.SEC_ACCT
...
AND A.S_DATE <= CAST('$PARAM{'e_date'}' AS DATE FORMAT 'YYYYMMDD')
AND A.E_DATE > CAST('$PARAM{'e_date'}' AS DATE FORMAT 'YYYYMMDD')
;
